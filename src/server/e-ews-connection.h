...
typedef enum {
	EWS_CONNECTION_STATUS_OK,
	EWS_CONNECTION_STATUS_INVALID_CONNECTION,
	EWS_CONNECTION_STATUS_INVALID_OBJECT,
	EWS_CONNECTION_STATUS_INVALID_RESPONSE,
	EWS_CONNECTION_STATUS_NO_RESPONSE,
	EWS_CONNECTION_STATUS_OBJECT_NOT_FOUND,
	EWS_CONNECTION_STATUS_UNKNOWN_USER,
	EWS_CONNECTION_STATUS_BAD_PARAMETER,
	EWS_CONNECTION_STATUS_ITEM_ALREADY_ACCEPTED,
	EWS_CONNECTION_STATUS_REDIRECT,
	EWS_CONNECTION_STATUS_CANCELLED,
	EWS_CONNECTION_STATUS_OTHER,
	EWS_CONNECTION_STATUS_UNKNOWN,
	EWS_CONNECTION_STATUS_INVALID_PASSWORD = 53273,
	EWS_CONNECTION_STATUS_OVER_QUOTA = 58652
} EwsConnectionStatus;
